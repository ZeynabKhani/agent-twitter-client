...
declare function fetchLikedTweets(userId: string, maxTweets: number, cursor: string | undefined, auth: TwitterAuth): Promise<QueryTweetsResponse>;
/**
 ...
 */
declare function getAllLikers(tweetId: string, auth: TwitterAuth): Promise<Liker[]>;
...
declare class Scraper {
     ...
     */
    getAllLikersOfTweet(tweetId: string): Promise<Liker[]>;
    /**
...
export { type Admin, type AudioData, type AudioDataWithUser, type AudioSpace, type AudioSpaceByIdResponse, type AudioSpaceByIdVariables, type AuthenticatePeriscopeResponse, type BroadcastCreated, type BrowseSpaceTopics, type BrowseSpaceTopicsResponse, type Category, ChatClient, type Community, type CommunitySelectQueryResponse, type CreatorResult, type GuestReaction, HlsRecordPlugin, IdleMonitorPlugin, JanusAudioSink, JanusAudioSource, JanusClient, type Liker, type LiveVideoSource, type LiveVideoStreamStatus, Logger, type LoginTwitterTokenResponse, type Metadata, MonitorAudioPlugin, type OccupancyUpdate, type Participants, type Plugin, type PluginRegistration, type Profile, type QueryProfilesResponse, type QueryTweetsResponse, RecordToDiskPlugin, Scraper, SearchMode, type Sharings, Space, SpaceParticipant, type SpeakerInfo, type SpeakerRequest, SttTtsPlugin, type Subtopic, type TurnServersInfo, type Tweet, type UserResults, fetchLikedTweets, getAllLikers };
